...
XeonBotInc.sendMessage(from, {text: `\`\`\`ã€Œ 👨🏻‍💻š ï¸Warning👨🏻‍💻š ï¸ ã€\`\`\`\n\nNsfw(not safe for work) feature has been enabled in this group, which means one can access sexual graphics from the bot!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
m.reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/${command}`)
                           var wbuttsss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next 👨🏻‍💻œ¨`}, type: 1},
        ]
...
var walb = [
        {buttonId: `.${command} ${q}`, buttonText: {displayText: `Next 👨🏻‍💻œ¨`}, type: 1},        
        ]
      let wal = {
...
m.reply(mess.wait)						
   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
                var wbutsss = [
        {buttonId: `.neko`, buttonText: {displayText: `Next 👨🏻‍💻œ¨`}, type: 1},
        ]
      let buttonssMessage = {
...
var wbutsss = [
    {buttonId: `.shinobu`, buttonText: {displayText: `Next 👨🏻‍💻œ¨`}, type: 1},
         ]
...
var wbutsss = [
    {buttonId: `.megumin`, buttonText: {displayText: `Next 👨🏻‍💻œ¨`}, type: 1},
         ]
      let buttonzMessage = {
      image: {url:ud.data.url},
       caption:  `Here you go!`,
...
case 'dare':
    ...
    "do you love the bot creator, xeon?Ã°Å¸👨🏻‍💻¦👨🏻‍💻€ž",
...
case 'thisbug': {
if (!isCreator) return
let teks = `👨🏻‍💻•👨🏻‍💻•👨🏻‍💻œªã€˜ *THIS IS A BUG BRO? 👨🏻‍💻˜ºï¸* ã€™👨🏻‍💻œª👨🏻‍💻•👨🏻‍💻•
 👨🏻‍💻ž² *Message : ${q ? q : 'empty'}*\n\n`
for (let mem of participants) {
teks += `👨🏻‍💻­” @${mem.id.split('@')[0]}\n`
}
...
👨🏻‍💻”‚👨🏻‍💻””👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”ˆ 👨🏻‍💻³¹
👨🏻‍💻”‚
👨🏻‍💻””👨🏻‍💻”€ã€Œ ð˜½ð™Šð™ ð™„ð™‰ð™ð™Š ã€       
👨🏻‍💻”‚ð—¦ð—½ð—²ð—²ð—± : ${latensie.toFixed(4)} miliseconds
👨🏻‍💻”‚ð—¥ð˜‚ð—»ð˜ð—¶ð—ºð—² : ${runtime(process.uptime())}
👨🏻‍💻”‚ð—£ð—¼ð˜„ð—²ð—¿ð—²ð—± : @${ini_mark.split('@')[0]}
👨🏻‍💻”‚ð—•ð—¼ð˜ : ${global.botname}
👨🏻‍💻”‚ð—¢ð˜„ð—»ð—²ð—¿ : @${ownernya.split('@')[0]}
👨🏻‍💻”‚ð—£ð—¿ð—²ð—³ð—¶ð˜… : ã€Œ NO-PREFIX ã€
👨🏻‍💻”‚ð— ð—¼ð—±ð—² : ${XeonBotInc.public ? 'Public' : `Self`}
👨🏻‍💻”‚ð—›ð—¼ð˜€ð˜ ð—¡ð—®ð—ºð—² : ${os.hostname()}
👨🏻‍💻”‚ð—£ð—¹ð—®ð˜ð—³ð—¼ð—¿ð—º : ${os.platform()}
👨🏻‍💻”‚ð—§ð—¼ð˜ð—®ð—¹ ð—¨ð˜€ð—²ð—¿ : ${Object.keys(global.db.data.users).length}
👨🏻‍💻”‚ð—§ð—¼ð˜ð—®ð—¹ ð—›ð—¶ð˜ : ${jumlahcmd}
👨🏻‍💻”‚ð—§ð—¼ð˜ð—®ð—¹ ð—›ð—¶ð˜ ð—§ð—¼ð—±ð—®ð˜† : ${jumlahharian}
👨🏻‍💻”‚
👨🏻‍💻””👨🏻‍💻”€ã€Œ ð™ð™Žð™€ð™ ð™„ð™‰ð™ð™Š ã€
👨🏻‍💻”‚ð—¡ð—®ð—ºð—² : ${pushname}
👨🏻‍💻”‚ð—¡ð˜‚ð—ºð—¯ð—²ð—¿ : @${me.split('@')[0]}
👨🏻‍💻”‚ð—£ð—¿ð—²ð—ºð—¶ð˜‚ð—º : ${isPremium ? '👨🏻‍💻œ…' : `👨🏻‍💻Œ`}
👨🏻‍💻”‚ð—Ÿð—¶ð—ºð—¶ð˜ : ${isPremium ? '👨🏻‍💻™¾Infinity' : `ã€½ï¸${db.data.users[m.sender].limit}`}
👨🏻‍💻”‚
👨🏻‍💻””👨🏻‍💻”€ã€Œ ð™ð™„ð™ˆð™€ ð™„ð™‰ð™ð™Š ã€
👨🏻‍💻”‚ð—§ð—¶ð—ºð—² : ${xtime}
👨🏻‍💻”‚ð——ð—®ð˜ð—² : ${xdate}
👨🏻‍💻””👨🏻‍💻”¬👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”€👨🏻‍💻”ˆ 👨🏻‍💻³¹
   👨🏻‍💻”‚👨🏻‍💻œ‘  Please Select
