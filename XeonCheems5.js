...
case 'tiktokmp3': 
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
            ...
            case 'joox': case 'jooxdl': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api.xteam.xyz/dl/jooxdl?APIKEY=5bd33b276d41d6b4&url=${text}`)
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api.xteam.xyz/dl/fbv2?APIKEY=5bd33b276d41d6b4&url=${text}`)
	        ...
	        case 'pindl': case 'pinterestdl': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(`https://api.xteam.xyz/dl/pinterestdl?APIKEY=5bd33b276d41d6b4&url=${text}`)
